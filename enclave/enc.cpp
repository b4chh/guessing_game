...
// Include the trusted game header that is generated
// during the build. This file is generated by calling the
// sdk tool oeedger8r against the game.edl file.
#include "game_t.h"
...
void enclave_guessing_game()
{
    ...
    oe_result_t result = host_game();
    if (result != OE_OK)
    {
        fprintf(
            stderr,
            "Call to host_game failed: result=%u (%s)\n",
            result,
